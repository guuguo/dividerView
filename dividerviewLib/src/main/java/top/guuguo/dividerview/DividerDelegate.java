...
public class DividerDelegate {
    ...
    /**
     * @param alineType divider位置  {@link DividerDrawable} dv_TL 等
     * @param dividerWidth divider粗度 
     * @param dividerLength divider长度，如果为0则自适应长度
     * @param dividerColor divider颜色
     * @param margin divider前后边距
     */
    public void addDivider(/*@DividerDrawable.AlignType*/ int alineType, int dividerWidth, int dividerLength,  int dividerColor, int margin) {
